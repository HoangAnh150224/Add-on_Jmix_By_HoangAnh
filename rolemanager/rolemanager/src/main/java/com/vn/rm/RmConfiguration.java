...
@PropertySource(name = "com.vn.rm", value = "classpath:/com/vn/rm/module.properties")
public class RmConfiguration {

    @Bean("rm_RmViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.vn.rm"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.vn.rm"));
        return actions;
    }
}
